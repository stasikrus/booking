...
const RoomPage = ({offer, hoveredOfferId, handleOfferCardHover}) => {
  ...
  const offersNear = offer.slice(0, 3);
        ...
        <div className="container">
          <section className="near-places places">
            ...
            <div className="near-places__list places__list">
              <OfferList offerCards={offersNear} offerCardHover={handleOfferCardHover} isNearOffer={true} />
            </div>
          </section>
        </div>
      </main>
...
export default withHoveredOffer(RoomPage);
